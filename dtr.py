...
class DTR():
    ...
    def _test(self, metric, ieee, target, testing_days, regressor_source, regressor_mix, regressor_target, regressor_transfer, verbose, store_predictions):
    ...
    def plot_results(self):
        ...
        # Extract the columns of data that you want to plot
